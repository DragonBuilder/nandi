...
So how do we trust the users to tell us who they are? Well that's where authetication & authorisation can help. This repository is a experimentation to explore various strategies for the same.
